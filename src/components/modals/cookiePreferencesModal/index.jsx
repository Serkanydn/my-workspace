    ...
    <div className="preferences-modal-container">
      <div className="header">
        ...
        <p>
          ...
          exercise your right to consent or object to a legitimate interest, based on a specific purpose below or at a partner level in the
          link under each purpose. These choices will be signaled to our vendors.
        </p>
